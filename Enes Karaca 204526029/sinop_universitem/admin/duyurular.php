...
<link href="css/sayfalar.css" type="text/css" rel="stylesheet"/>
	...
	<a href="admin.php?s=duyuru_ekle"><div class="yeni_sayfa_eklem">
...
<div class="hizalama_bitir"></div>
	...
	<div>
      ...
      <?
	  $i=0;
	  	$sql=" select * from duyurular order by d_id asc ";
      ...
      <tr class=""  bgcolor="<? echo $renk;?>">
        ...
        <td td style="width: 70px; text-align: center;"><? echo $kayit['d_baslik'];?></td>
        <td td style="width: 70px; text-align: center;"><a href="duyuru_sil_islem.php?sil_id=<? echo $kayit['d_id'];?>">
			<img src="admin_images/sil_icon.png" width="30px" height="30px"/></a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="admin.php?s=duyuru_guncelle&g_id=<? echo $kayit['d_id'];?>">
